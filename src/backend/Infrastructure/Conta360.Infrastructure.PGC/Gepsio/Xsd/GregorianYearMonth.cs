...
{
	/// <summary>
	/// An encapsulation of the XML schema type "gregorianYearMonth" as defined in the http://www.w3.org/2001/XMLSchema namespace. 
	/// </summary>
	/// <remarks>
	/// <para>
	...
	/// </para>
	/// </remarks>
    public class GregorianYearMonth : AnySimpleType
    {
    }
}

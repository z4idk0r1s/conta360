...
{
    /// <summary>
    /// An encapsulation of the XML schema type "nonNegativeInteger" as defined in the http://www.w3.org/2001/XMLSchema namespace. 
    /// </summary>
    /// <remarks>
    /// <para>
    ...
    {
        internal NonNegativeInteger(INode StringRootNode)
            : base(StringRootNode)
        {
        }
    }

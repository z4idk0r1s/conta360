...
{
	/// <summary>
	/// An encapsulation of the XML schema type "boolean" as defined in the http://www.w3.org/2001/XMLSchema namespace. 
	/// </summary>
	/// <remarks>
	/// <para>
    ...
    {
		internal Boolean(INode StringRootNode) : base(StringRootNode)
		{
		}
	}
}
